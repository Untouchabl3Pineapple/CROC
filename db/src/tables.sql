-- Удаление сущностей
DROP TABLE IF EXISTS Events, EventsTypes, Userss, ButtonsEvents, ButtonsPosts;
...
(
    ...
    User_Login          VARCHAR(255) REFERENCES Userss(Login)
);